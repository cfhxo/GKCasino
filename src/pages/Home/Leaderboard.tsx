        ...
        <div className="flex flex-col items-center justify-center max-w-[360px] md:max-w-none  z-50 ">
            ...
            {!loading && users[1] ? (
                <div className="flex gap-14 my-16 ">
                    <TopPlayer key={`topplayer-${users[1].id}`} user={users[1]} rank={2} />
                    <TopPlayer key={`topplayer-${users[0].id}`} user={users[0]} rank={1} />
                    <TopPlayer key={`topplayer-${users[2].id}`} user={users[2]} rank={3} />
                </div>
            ) : (
