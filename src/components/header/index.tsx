...
const Header: React.FC<Header> = ({ onlineUsers, recentCaseOpenings, notification, setNotification }) => {
  ...
  return (
    <div className="flex flex-col p-4 w-screen justify-center ">
      {/* Important Red Banner */}
      <div className="w-full bg-red-600 text-white text-center py-2 px-4 rounded-md mb-4 font-semibold text-sm shadow-md">
        Important: Any accounts made before 19th April 2025 may need to reset their password with the new reset system provided. Any NEW users will require a verified email.<br />
        Any users with fake emails and unable to reset, please contact <a href="mailto:casino-accounts@ghana-kebabs.com" className="underline font-bold">casino-accounts@ghana-kebabs.com.</a>
      </div>
